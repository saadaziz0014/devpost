              ...
              <div className="flex flex-col gap-3">
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col border-4 shadow-inherit p-2">
                    ...
                    <h2 className="text-blue-800 text-xl">3</h2>
                  </div>
                  <div className="flex flex-col border-4 shadow-inherit p-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col border-4 shadow-inherit p-2">
                    ...
                    <h2 className="text-blue-800 text-xl">1</h2>
                  </div>
                  <div className="flex flex-col border-4 shadow-inherit p-2">
                    ...
                    <h2 className="text-blue-800 text-xl">8</h2>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="col-span-3 border-l-2 py-4">
            <div className="flex flex-col gap-3 px-2">
